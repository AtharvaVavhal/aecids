...
The primary objective of the evaluation phase is to validate whether AECIDS achieves an effective balance between edge responsiveness, cloud intelligence, and explainability while operating within the resource constraints of embedded IoT gateways.

Hardware-in-the-loop experiments will be performed after completion of backend integration and edge deployment.

> [!NOTE]
> Quantitative benchmark results will be published only after experimental validation. No empirical values are reported in this repository until they are reproducible.
...
| Objective | Description |
|------------|-------------|
| Edge Performance | Measure latency and memory utilization of the embedded inference engine. |
| Cloud Performance | Evaluate inference throughput and request scalability. |
| Routing Efficiency | Measure the percentage of flows processed locally versus escalated to the cloud. |
| Calibration Quality | Assess confidence estimation reliability after post-hoc calibration. |
| Explainability | Evaluate the consistency and usefulness of TreeSHAP feature attributions. |
| Adaptation | Observe routing threshold evolution under changing traffic distributions. |
...
FeatureExtraction --> EdgeInference

EdgeInference --> Calibration

Calibration --> Routing

Routing --> LocalEvaluation

Routing --> CloudEvaluation

CloudEvaluation --> TreeSHAP

TreeSHAP --> ThresholdOptimization

ThresholdOptimization --> FinalMetrics
```
...
| Experiment | Status |
|------------|--------|
| Edge Benchmarking | Planned |
| Cloud Benchmarking | Planned |
| Hardware Validation | Planned |
| Routing Analysis | Planned |
| Explainability Analysis | Planned |
| Comparative Study | Planned |

---

# Security Operations Center

The Security Operations Center (SOC) provides a centralized interface for monitoring edge gateways, cloud inference, routing behaviour, and explainability results.

The dashboard is designed around operational clarity rather than visual complexity, enabling security analysts to inspect alerts, routing decisions, and model explanations in real time.
...
| Module | Purpose |
|---------|---------|
| Overview | High-level system health and traffic summary |
| Threat Feed | Real-time intrusion events |
| Edge Gateways | Connected gateway monitoring |
| Cloud Analytics | Secondary inference statistics |
| Explainability | TreeSHAP feature attribution |
| Threshold Monitor | Adaptive routing visualization |
| Audit Logs | Historical event timeline |
...
| Dashboard | Preview |
|-----------|---------|
| SOC Overview | `docs/images/soc-dashboard.png` |
| Live Threat Feed | `docs/images/threat-feed.png` |
| Gateway Monitoring | `docs/images/gateway-monitor.png` |
| Explainability View | `docs/images/shap-dashboard.png` |
| Threshold Analytics | `docs/images/threshold-dashboard.png` |

---

# Engineering Decisions

AECIDS intentionally prioritizes architectural simplicity, deterministic behaviour, and deployment practicality.

Every major design decision reflects a specific engineering trade-off.
...
The project is intentionally designed around practical deployment limitations.
...
Development is organized into incremental engineering milestones.
...
The current implementation establishes the architectural foundation for adaptive Edge–Cloud intrusion detection.
...
- Support for additional explainability techniques.
- Hardware acceleration using NVIDIA Jetson and Coral TPU.
...
- The proposed change aligns with the architectural principles described in this document.
- Documentation is updated alongside implementation changes.
- New functionality includes appropriate tests.
- Existing interfaces remain backward compatible whenever possible.

For significant architectural proposals, please open an issue before implementation.
...
If you use AECIDS in academic work, please cite this project after publication.

A formal BibTeX citation will be added once the accompanying research paper becomes publicly available.
...
Engineering Design & Innovation (EDI)
...
Designed and developed as part of the Engineering Design & Innovation (EDI) curriculum at Vishwakarma Institute of Technology (VIT), Pune.
